...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/air/tbCO2/">CO2列表</a></li>
		<shiro:hasPermission name="air:tbCO2:edit"><li><a href="${ctx}/air/tbCO2/form">CO2添加</a></li></shiro:hasPermission>
	</ul>
		...
		<c:forEach items="${page.list}" var="tbCO2">
			<tr>
				...
				<shiro:hasPermission name="air:tbCO2:edit"><td>
					...
					<a href="${ctx}/air/tbCO2/delete?id=${tbCO2.id}" onclick="return confirmx('确认要删除该CO2吗？', this.href)">删除</a>
